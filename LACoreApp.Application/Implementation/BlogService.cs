...
namespace LACoreApp.Application.Implementation
{
    public class BlogService : IBlogService
    {
        ...
        {
            return _mapper.ProjectTo<BlogViewModel>(_blogRepository.FindAll(x => x.Status == Status.Active).OrderByDescending(x => x.DateCreated).Take(top)).ToList();
        }
        ...
        public List<BlogViewModel> GetMostView(int top) => _mapper.ProjectTo<BlogViewModel>(_blogRepository.FindAll()
